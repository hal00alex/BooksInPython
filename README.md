...
-WIP: [JimmyCoates.py](https://github.com/hal00alex/BooksInPython/blob/master/JImmyCoates.py) is an random number based equation that determines if Jimmy will beat his programming 
